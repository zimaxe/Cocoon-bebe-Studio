...
class CustomerType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('babyName', TextType::class, array( 'label' => 'Nom du bébé : ', 'required' => false))
            ->add('babyFirstName', TextType::class, array( 'label' => 'Prénom du bébé : ', 'required' => false))
            ...
            ->add('weight', NumberType::class, array('scale' => 2, 'label' => 'Poids du bébé :', 'required' => false))
            ->add('height', TextType::class, array('label' => 'Taille du bébé :', 'required' => false))
            ...
            ->add('mobileFather', TextType::class, array('label' => 'Portable du Papa :', 'required' => false))
            ->add('emailMother', EmailType::class, array('label' => 'Email de la Maman* :'))
            ->add('emailFather', EmailType::class, array('label' => 'Email du Papa :', 'required' => false))
        ;
    }
